...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen min-w-[100vw] bg-gradient-to-r from-[#121212] to-[#9EDA25] flex items-center justify-center">
      <Card className="mx-auto max-w-sm bg-white shadow-md rounded-lg">
        <CardHeader>
